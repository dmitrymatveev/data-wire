...
Type.Any.assignValue = function (modelInstance, valueName, value, setDirtyToValue) {
    ...
    this.resetValue(modelInstance, valueName, valid, setDirtyToValue);
 ...
 * @param {Boolean} setDirtyToValue
 */
Type.Any.resetValue = function (modelInstance, valueName, value, setDirtyToValue) {

    if (this.virtual) modelInstance[valueName] = value;
    else {
