...
/**
 * Called before value is assigned to instance.
...
function defineProperty (obj, key) {
    ...
    var def = obj._model.definition[key];
    ...
    Object.defineProperty(obj, key, {
        ...
        set : function (v) {
            ...
            if (def.validate && !def.validate(v)) {
                throw new Error('Assignment validation error: ' + key + ' = ' + v);
            }

            obj._state.dirty[key] = def.valueDecorator ? def.valueDecorator(v) : v;
